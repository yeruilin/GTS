...
class NLOSDataset(Dataset):
    def __init__(self, data_path,z=0.0,filter=False):
        try:
            ...
            # self.data=self.data[2:self.data.shape[0]:6,2:self.data.shape[1]:6,:]
            # self.data=self.data[2:self.data.shape[0]:4,2:self.data.shape[1]:4,:]
...
class MultiViewDataset(Dataset):
    def __init__(self, data_path):
        try:
            ...
            # self.data=self.data[:256*256*2,151:350]
            # self.grid=self.grid[:256*256*2,:]
            # self.view_id=self.view_id[:256*256*2,:]
