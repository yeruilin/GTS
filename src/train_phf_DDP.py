...
def train(rank, args):
    ...
    # scale=0.002
    min_pos=[-0.5,-0.5,0.85] ## phasor_id11的参数(shelves_1000ms_lightoff_data)
    max_pos=[0.8,0.8,1.1]
    grid_size=[0.0075,0.0075,0.0075]
    scale=0.002
    # decay=2
    ...
    # scale=0.002
    # min_pos=[-1.0,-0.55,0.4] ## office phasor id1-3的参数(office10ms_data)
    # max_pos=[0.8,0.7,1.3]
    # grid_size=[0.0075,0.0075,0.015]
    # scale=0.002
